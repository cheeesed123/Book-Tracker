...
public class Word {
     ...
     * @see #CSVVARCOUNT
     */
    //Dont forget to sync with others!!!!!! AHFJAKFHASKFJHASFKJAHSFKJAHSF SYNC ITTTTT
    ...
    */
    ...
    /**The path to the csv. That's all. */
    final public static Path path = Paths.get("lib", "books.csv");
    /** It takes a user input, and if it matches condition1, it returns true.
     * If it matches condition2, it returns false.
     * Else, if keeps the user in a loop.
    ...
    */
    ...
    /**
     * A small reference to {@link #nextLine(String)}.
     * This acts identical to {@code new Scanner(System.in).nextLine();}
    ...
    /** A simple boolean, it takes a String array, and if it finds {@code choice} inside of it it returns true
     * @param options the String array.
     * @param choice the target, or what to look for.
     * @return a true or false, depending on if it finds it.
     * @see Runner#BookSeries()
     */
